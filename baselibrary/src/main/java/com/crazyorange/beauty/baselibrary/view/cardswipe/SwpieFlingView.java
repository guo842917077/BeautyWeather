package com.crazyorange.beauty.baselibrary.view.cardswipe;
...
import com.crazyorange.beauty.baselibrary.R;

import java.util.ArrayList;

public class SwpieFlingView extends BaseFlingAdapterView {
    ...
    public SwpieFlingView(Context context) {
        this(context, null);
    }

    public SwpieFlingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwpieFlingView(Context context, AttributeSet attrs, int defStyle) {
